...
\section{What is left to do}
  ...
  In another part of our runway demonstration, we will use a zoom lens, an NIR camera, and an RGB camera to produce one output. Because the cameras are spaced far apart relative to the model runway, we will need to implement an overlay function in order to combine the video produced by the three camera correctly. Figure 9 is a good example of the image we'd produce without an image overlay algorithm.
